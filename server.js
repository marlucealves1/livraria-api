...
app.post("/livros", (request, response) => {
 ...
 conn.query(checksql, (err, data)=>{
    ...
    const insertSql =/*sql*/ `INSERT INTO livros (livro_id, titulo, autor, ano_publicaçao, genero, preço, disponibilidade) VALUES("${id}", "${titulo}", "${ano_publicacao}", "${genero}", "${preco}", "${disponibilidade}")`; 
